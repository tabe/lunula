...
(assert-boolean=? #f (guide (validate-2/5-1/5-0/5 #f)
                       (lambda (ht)
                         (assert-hashtable-contains? ht 'not-a-list)
                         (assert-null? (hashtable-ref ht 'not-a-list #f))
                         #f)
                       (lambda _ #t)))
(assert-boolean=? #f (guide (validate-2/5-1/5-0/5 '("a" ""))
                       (lambda (ht)
                         (assert-hashtable-contains? ht 'list-too-short)
                         (assert-= 2 (hashtable-ref ht 'list-too-short #f))
                         #f)
                       (lambda _ #t)))

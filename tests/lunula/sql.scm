...
(assert-call-with-tuple ((("t0_0.id" "t0_0.created_at" "t0_0.updated_at" "t0_0.x" "t0_0.y")
                          ("t0_1.id" "t0_1.created_at" "t0_1.updated_at" "t0_1.foo_id" "t0_1.y" "t0_1.z"))
                         "SELECT t0_0.id, t0_0.created_at, t0_0.updated_at, t0_0.x, t0_0.y, t0_1.id, t0_1.created_at, t0_1.updated_at, t0_1.foo_id, t0_1.y, t0_1.z FROM foo t0_0 JOIN bar t0_1 ON t0_1.foo_id = t0_0.id WHERE t0_0.y = '200' AND t0_1.y = '100' ORDER BY t0_0.id desc LIMIT 10 OFFSET 5")
                        values (foo (bar (foo))) ((bar (y 100)) (foo (y 200))) ((order-by (foo (id desc))) (offset 5) (limit 10)))
(assert-call-with-tuple ((("t0_0.id" "t0_0.created_at" "t0_0.updated_at" "t0_0.x" "t0_0.y")
                          ("t0_1.id" "t0_1.created_at" "t0_1.updated_at" "t0_1.foo_id" "t0_1.y" "t0_1.z"))
                         "SELECT t0_0.id, t0_0.created_at, t0_0.updated_at, t0_0.x, t0_0.y, t0_1.id, t0_1.created_at, t0_1.updated_at, t0_1.foo_id, t0_1.y, t0_1.z FROM foo t0_0 LEFT JOIN bar t0_1 ON t0_1.foo_id = t0_0.id WHERE t0_0.y = '200' AND t0_1.y = '100' ORDER BY t0_0.id desc LIMIT 10 OFFSET 5")
